        ...
        while not self.exit:
            if self.com != None:
                ...
                if n > 0:
                    ...
                    msg = self.decode(opcode[0], data, chksum)
    ...
    def build_message(self, data):
        ...
        if opcodehi == 0x8:
            ...
            if n == 3:
                ...
                print(
                    "WARNING: trying to send message that does not have 2 data bytes in 2-byte message. Not sending...",
                    file=sys.stderr,
                )
        elif opcodehi == 0xE:
  ...
  """
    ...
    def set_global_power(self, state):
        if state == LocoNet.POWER_ON:
            ...
            print(
                "WARNING: set_global_power(): unknown state = " + str(state),
                file=sys.stderr,
            )
